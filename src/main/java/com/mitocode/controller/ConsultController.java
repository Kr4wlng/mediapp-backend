...
public class ConsultController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ConsultDTO> update(@Valid @PathVariable Integer id, @RequestBody ConsultDTO dto){
        dto.setIdConsult(id);
    ...
    public ResponseEntity<List<ConsultDTO>> searchByDates(
            @RequestParam(value = "date1", defaultValue = "2026-07-01") String date1,
            @RequestParam(value = "date2", defaultValue = "2026-07-29") String date2
    ){
